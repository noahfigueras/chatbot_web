...
export default function Sidebar() {
  ...
  const navItems = [
    { label: t("dashboard"), href: "/dashboard", icon: icons.dashboard },
    { label: t("chatbots"), href: "/dashboard/chatbots", icon: icons.chatbots },
    { label: t("billing"), href: "/dashboard/billing", icon: icons.billing },
    { label: t("settings"), href: "/dashboard/settings", icon: icons.settings },
  ];
