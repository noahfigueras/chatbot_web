export default function CTA() {
  return (
    <section className="relative py-24 sm:py-32 overflow-hidden">
      ...
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-neon-cyan/5 blur-3xl pointer-events-none"
      />
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
        ...
        <p className="text-lg sm:text-xl text-text-muted max-w-2xl mx-auto">
          Join 500+ businesses already using ChatBot Pro. Get your chatbot live
          in minutes, not days.
        </p>
